		...
		<div class="bl_c">
			...
			<div class="up_c">
				...
				<div class="up_lt">
					...
					<div class="up_li pass_ubd_btn">
						<div class="menu_cin"><i class="fal fa-key"></i></div>
						<div class="menu_cih">Пароль</div>
					</div>
				...
				<div class="up_lt">
					...
					<a class="up_li" href="#">
						...
						<div class="menu_cih">Платформа жайлы</div>
					</a>
...
<? include "../block/footer.php"; ?>
	...
	<!-- user plus -->
	<div class="pop_bl pop_bl2 pass_ubd">
		<div class="pop_bl_a pass_ubd_back"></div>
		<div class="pop_bl_c">
			<div class="head_c">
				<h4>Пароль өзгерту</h4>
				<div class="btn btn_dd pass_ubd_back"><i class="fal fa-times"></i></div>
			</div>
			<div class="pop_bl_cl">
				<div class="form_c">
					<div class="form_im ">
						<div class="form_span">Пароль:</div>
						<input type="text" class="form_txt pass" placeholder="Жаңа пароль жаз" data-lenght="6">
						<i class="fal fa-key form_icon"></i>
					</div>
					<div class="form_im form_im_bn">
						<div class="btn pass_ubd_send" data-id="<?=$user_id?>">Ауыстыру</div>
					</div>
				</div>
			</div>
		</div>
